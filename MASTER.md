...
- Status: functional scaffold on `dev`; first Windows installer pipeline validated end-to-end; slimmer pinned FFmpeg toolchain validation pending / no public release
